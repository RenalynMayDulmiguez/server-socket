...
document.addEventListener('DOMContentLoaded', function() {
    profilepic.innerHTML = `<img src="http://localhost:3001/api/uploads/${user.profilepic}" style="height:300px; width:300px; margin:20px; border:2px  solid  black;"/> 
    <p>${user.username}</p><br>
    <button type="button" class="btn btn-primary mb-2" id="logout-btn">Logout</button>`
